...
namespace MasteriesQuest.ViewModels
{
    public class SummonerSearchViewModel : ObservableObject
    {
        ...
        [Required]
        public string? SummonerName { get => _summonerName; set => SetProperty(ref _summonerName, value); }

#if WINDOWS
        public Server Server { get => _server; set => SetProperty(ref _server, value); }
#else
        [Required]
        public Camille.Enums.PlatformRoute Platform { get => _server; set => SetProperty(ref _server, value); }
#endif
